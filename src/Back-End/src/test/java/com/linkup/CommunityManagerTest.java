...
public class CommunityManagerTest {
    ...
    public void testCreateCommunity() throws FrontEndUsageException {
        ...
        // Assert
        assertEquals(Integer.valueOf(1), CommunityManager.CreateCommunity("CommunityName", "username"));
    }
    ...
    public void testTransferCommunityOwnership() throws FrontEndUsageException {
        ...
        // Assert
        assertEquals(Integer.valueOf(1), CommunityManager.transferCommunityOwnership("CommunityName", "newUsername"));
    }
    ...
    public void testDeleteCommunity() throws FrontEndUsageException {
        ...
        // Assert
        assertEquals(Integer.valueOf(1), CommunityManager.DeleteCommunity("CommunityName"));
    }
}
