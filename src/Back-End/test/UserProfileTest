...
public class UserProfileTest {
    ...
    // testSetFullName: 
    // Tests the setFullName method to ensure that the full name of the user can be set and retrieved correctly.
    ...
    // testSetBio: 
    // Tests the setBio method to ensure that the user's bio can be set and retrieved correctly.
    ...
    // Tests the setProfilePictureUrl method to ensure that the profile picture URL can be set and retrieved correctly.
    ...
    // Tests the setLastLoginDate method to ensure that the last login date can be set and retrieved correctly.
