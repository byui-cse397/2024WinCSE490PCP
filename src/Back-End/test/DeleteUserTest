...
public class DeleteUserTest {
    /*
      testValidDeletion: 
        Tests if a user account can be successfully deleted with valid deletion credentials and confirms that the deletion date is set.
    */
    ...
    public void testValidDeletion() {
        ...
        // Act
        DeleteUser deleteUser = new DeleteUser(userId, username, email, password, confirmationPassword, deletionReason);
    ...
    /*
      testInvalidPassword: 
        Tests if deletion fails when the confirmation password doesn't match the user's password.
    */
